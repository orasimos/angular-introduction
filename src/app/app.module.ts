...
const routes: Routes = [
  { path: 'bind-examples', loadChildren: () => 
      import('./bind-examples-module/bind-examples.module')   //imported modules should go first in the routes
        .then((m) => m.BindExamplesModule
      ) 
  },
  { path: 'greeting', component: GreetingComponent },
  { path: 'structural-directives', component: StructuralDirectivesComponent },
  { path: 'template-variables', component: TemplateVariablesComponent },
  { path: 'input', component: ComponentInputComponent },
  { path: 'input-output', component: ComponentInputOutputComponent },
